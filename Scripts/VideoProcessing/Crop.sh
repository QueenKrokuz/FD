...
cd "./SCCichlidVid/Group/_Noncropped"
...
for i in *.avi; do 
    ...
    ffmpeg -i "$i" -vf "crop=286:153:14:71" -c:v h264 -c:a copy ./SCCichlidVid/Group/Cropped/crop"$name".avi
    # Move the uncropped avi to the Originals folder
    mv "./SCCichlidVid/Group/_Noncropped/$i" "./SCCichlidVid/Group/Originals/$i"
# End loop
done
